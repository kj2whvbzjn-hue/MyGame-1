...
namespace GuildAdventure.Tests.EditMode
{
 public sealed class DotDamagePipelineTests
 {
  ...
  [Test] public void Dot_ConsumesBarrierBeforeHp(){var s=Snapshot(10,5);var layers=new List<BarrierLayer>{new BarrierLayer{id="X",remaining=3}};var o=new BattleTickOptions{readBarriers=a=>layers,writeBarriers=(a,x)=>layers=x};var r=BattleTickRuntime.Advance(s,o);Assert.IsTrue(r.ok);Assert.AreEqual(8,s.actors[0].hp);Assert.AreEqual(3,r.barrierAbsorbed);Assert.AreEqual(2,r.dotHpLoss);}
