...
namespace GuildAdventure.Tests.EditMode
{
 public sealed class BattleTickAiReevaluationTests
 {
  ...
  static FormalAiBattleContext Context(System.Func<bool> condition){var p=new FormalAiProgram{entry_node_id="C",nodes=new[]{new FormalAiNode{instance_id="C",node_type="condition"},new FormalAiNode{instance_id="A",node_type="action"}},edges=new[]{new FormalAiEdge{from=new FormalAiPortRef{node_id="C",port_id="true"},to=new FormalAiPortRef{node_id="A"}},new FormalAiEdge{from=new FormalAiPortRef{node_id="C",port_id="false"},to=new FormalAiPortRef{node_id="A"}}}};return new FormalAiBattleContext{program=p,execution=new FormalAiExecutionContext{condition=n=>condition()}};}
