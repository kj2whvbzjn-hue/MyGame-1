...
namespace GuildAdventure.Tests.EditMode
{
 ...
 {
  static EffectApplyRequest Req(string id,double value,int tick,int seq)=>new EffectApplyRequest{instanceId=id,sourceId="S",effectId="ATK_UP",kind=EffectLifecycleKind.BUFF,stackRule=EffectStackRule.STACK_HIGHEST,refreshRule="KEEP",snapshotPolicy="SNAPSHOT",dispelCategory="BUFF",baseDurationTicks=10,value=value,appliedTick=tick,sequence=seq,maxStacks=2};
