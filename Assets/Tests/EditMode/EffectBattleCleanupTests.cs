...
namespace GuildAdventure.Tests.EditMode
{
 ...
 {
  [Test] public void DotDeath_RemovesOnlyEffectsMarkedForDeathCleanup(){var s=S();var a=s.actors[0];Apply(a,"D","DOT",EffectLifecycleKind.DOT,false,true);Apply(a,"KEEP","BUFF",EffectLifecycleKind.BUFF,false,false);a.hp=2;var r=BattleTickRuntime.Advance(s);Assert.IsTrue(r.ok,r.reason);Assert.IsFalse(a.alive);Assert.AreEqual(1,a.appliedEffects.Count);Assert.AreEqual("KEEP",a.appliedEffects[0].instanceId);}
