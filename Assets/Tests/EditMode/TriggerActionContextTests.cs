...
namespace GuildAdventure.Tests.EditMode
{
 public sealed class TriggerActionContextTests
 {
  ...
  [Test] public void NonPositiveLimit_UsesFormalDefaultSixteen(){var a=new TriggerActionContext{activationLimit=0};for(var i=0;i<16;i++){var id="P"+i;Assert.IsTrue(TriggerActivationRuntime.TryActivate(a,id,1,null).ok);TriggerActivationRuntime.Release(a,id);}Assert.AreEqual(TriggerActivationRuntime.LimitReached,TriggerActivationRuntime.CanActivate(a,"P16").reason);}
 }
}
#endif
