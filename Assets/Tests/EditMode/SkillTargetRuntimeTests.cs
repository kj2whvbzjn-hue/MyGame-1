...
namespace GuildAdventure.Tests.EditMode
{
 public sealed class SkillTargetRuntimeTests
 {
  ...
  [Test] public void RandomCount_SelectsWithoutReplacement(){var s=S();var rng=new Rng{value=.9};var r=SkillTargetRuntime.Resolve(s,new SkillTargetRequest{sourceId="A",category=SkillTargetCategory.ENEMY,range=SkillTargetRange.RANDOM,randomCount=2,candidateIds=new[]{"B","C"}},rng);Assert.IsTrue(r.ok,r.reason);CollectionAssert.AreEqual(new[]{"C","B"},r.targetIds);Assert.AreEqual(1,rng.calls);}
