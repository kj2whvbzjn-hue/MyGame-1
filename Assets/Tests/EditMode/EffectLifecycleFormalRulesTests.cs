...
namespace GuildAdventure.Tests.EditMode
{
 public sealed class EffectLifecycleFormalRulesTests
 {
  ...
  [Test] public void Buff_KeepHighest_PreservesIndependentStacks(){var a=new BattleActorSaveRecord();var high=Req("A","ATK_UP",EffectLifecycleKind.BUFF,20);high.baseDurationTicks=1;var low=Req("B","ATK_UP",EffectLifecycleKind.BUFF,10);low.baseDurationTicks=5;EffectLifecycleRuntime.Apply(a,high);EffectLifecycleRuntime.Apply(a,low);Assert.AreEqual(2,a.appliedEffects.Count);Assert.AreEqual(20,EffectLifecycleRuntime.EffectiveValue(a,"ATK_UP",EffectLifecycleKind.BUFF));a.appliedEffects[0].remainingTicks=0;a.appliedEffects.RemoveAll(x=>x.remainingTicks<=0);Assert.AreEqual(10,EffectLifecycleRuntime.EffectiveValue(a,"ATK_UP",EffectLifecycleKind.BUFF));}
